...
async def cmd_start(message: Message):
    ...
    if user_id in ADMINS:  # Проверяем, что пользователь - админ
        ...
        await message.answer(
            """<b>🏪 ArhDzagi</b> - доставка никотиновой и безникотиновой продукции

        <b>🛒 Как сделать заказ:</b>
        1. Нажмите кнопку <b>"🛍️ Заказать"</b>
        2. Выберите товары в каталоге
        3. Оформите заказ в корзине

        <b>🚚 Доставка:</b>
        • Соломбала, Город - <b>БЕСПЛАТНО</b>
        • Самовывоз - уточняйте адрес

        <b>⏰ Часы работы:</b>
        • С 13:00 до 23:30
        • Приём заказов до 23:00
